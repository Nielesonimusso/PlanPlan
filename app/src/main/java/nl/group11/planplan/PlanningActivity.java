...
public class PlanningActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout_planning);
        ...
        RecyclerView recyclerView = (RecyclerView) findViewById(R.id.planningRecycler);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        recyclerView.setAdapter(new MixedFirebaseAdapter(this));
    }
